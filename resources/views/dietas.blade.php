...
<div class="recetas" id="recetas">
    <div class="container">
        <div class="row">
            <div class="section-title">
                <h1>Dieta</h1>
                <p class="small text-uppercase">Genera tu dieta</p>
            </div>
...
<form action="{{ route('dieta.sendMessage') }}" method="post">
  ...
  <input type="text" name="message" id="message" placeholder="Ejemplo: genera dieta sin legumbres" class="form-control"/>
